...
Se o item for uma correção de defeito, classifique antes se existe uma resposta urgente, uma investigação ainda sem escopo ou um conserto comparável. O guia de [como estimar bugs com story points](/artigos/estimar-bugs-planning-poker) separa essas três decisões.
