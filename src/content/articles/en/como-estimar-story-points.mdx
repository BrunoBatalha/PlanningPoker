...
If the team still needs to learn the complete activity, start with [What is Planning Poker?](/en/what-is-planning-poker). For quick questions about cards, participants, and the reveal, visit the [Battle Poker FAQ](/en/faq).
...
Fibonacci supports decisions on a numerical scale with widening intervals. Sizes such as S, M, and L can be faster for grouping many items that are still lightly detailed. Choose the scale that fits the decision you need to make, and keep the reference points clear.
